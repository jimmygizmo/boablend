...
# See: /boas/cube_corkscrew_deluxe_info.txt
...
# specifying integer full rotations and then calculate a full multiple of 360
# for our 'completion_angle'
...
# the camera using the camera.write() code below here.
...
while (not total_angle > completion_angle):
    ...
    # Does not appear to be causing the view to update as desired:
...
# standard bake. Having trouble finding a way to set the end_frame for the
# Simulation/Bake.
